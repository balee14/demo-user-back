...
public enum CommonCustomType {
    ...
    CLIENT_ERROR_401_31(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"31","KpUserUtil.getUserId"),
    CLIENT_ERROR_401_32(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"32","KpUserUtil.getIdEmail"),
    CLIENT_ERROR_401_33(CommonResponseEntityType.UNAUTHORIZED.getResponseCode(),"33","KpUserUtil.getUserName"),
